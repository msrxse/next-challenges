      ...
      <div className="grid bg-amber-100 lg:grid-cols-6">
        ...
        <ul className="list-disc space-y-4 pl-6 lg:col-span-3">
          <li className="text-xs text-gray-900">
            Using css-variables and calc() is more expressive and any changes
            will update in all places. Tailwind uses REM units for border-radius
            and padding by default. Everything will be trully linked.
          </li>
          <li className="text-xs text-gray-900">
            Image is using baseball card protector pattern, with glassy
            background and rounded corners. Nested border-radius always off
            unless you use calculation. (Do not use the same.)
          </li>
          <li className="text-xs text-gray-900">
            How to calculate the perfect border radius for nested elements:
            Internal border-radius would be: calc(border-radius - padding). That
            is, take the parent border-radius and subtract the padding - that
            will give your the child border-radius.
          </li>
          <li className="text-xs text-gray-900">
            We use CSS-variables so the whole UI stays perfect and in-sync
          </li>
        </ul>
      </div>
        ...
        <div className="mx-auto flex max-w-md flex-col gap-y-10">
          <div className="rounded-(--card-radius) bg-white/15 p-(--card-padding) outline -outline-offset-1 outline-white/25 [--card-padding:--spacing(3)] [--card-radius:var(--radius-4xl)]">
            <Image
              ...
              alt="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=2102&amp;q=80"
              width="454"
              height="681"
            />
          </div>
          <figure className="relative isolate pt-6">
            ...
            <figcaption className="mt-8 text-base">
              ...
              <div className="mt-1 text-gray-400">CEO of Workstation</div>
            </figcaption>
          </figure>
        </div>
      </div>
