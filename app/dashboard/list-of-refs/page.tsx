...
function Page() {
  ...
  return (
    <main className="flex h-full flex-col items-center justify-center overflow-hidden bg-gray-100">
      List of Refs
      <div className="py-2">
        {cats.map((cat) => (
          <button
            key={cat.id}
            className="mx-1 rounded-md bg-blue-500 px-3 py-0.5 text-white hover:bg-blue-600 active:bg-blue-800"
      ...
      <div className="container overflow-scroll">
        <div className="flex w-[1600px] flex-row">
          {cats.map((cat) => (
            <div
              key={cat.id}
              ref={(node) => {
